...
namespace PDS.UndoRedo
{
        ...
        IUndoRedoDataStructure<T, IUndoRedoSet<T>>
    {
        ...
        new IUndoRedoSet<T> Add(T value);
        ...
        new IUndoRedoSet<T> Except(IEnumerable<T> other);
        ...
        new IUndoRedoSet<T> Intersect(IEnumerable<T> other);
        ...
        new IUndoRedoSet<T> Remove(T value);
        ...
        new IUndoRedoSet<T> SymmetricExcept(IEnumerable<T> other);
        ...
        new IUndoRedoSet<T> Union(IEnumerable<T> other);
    }
}